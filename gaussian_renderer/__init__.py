...
from differentiable_gaussian_mixture_renderer.python_bindings import vol_marcher
...
def render(viewpoint_camera, pc : GaussianModel, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None):
    ...
    rotations = None
    cov3D_precomp = None
    if pipe.compute_cov3D_python and pipe.renderer == "inria_splatter":
    ...
    shs = None
    colors_precomp = None
    if override_color is None or pipe.renderer != "inria_splatter":
        if pipe.convert_SHs_python and pipe.renderer == "inria_splatter":
